...
export const useSEO = (config: SEOConfig) => {
  useEffect(() => {
    ...
    updateOrCreateMeta('og:image', config.ogImage || 'https://www.adbjip.fr/og-image.jpg');
    ...
    updateOrCreateMeta('twitter:image', config.ogImage || 'https://www.adbjip.fr/og-image.jpg', false);
