    ...
    <div className="min-h-screen">
      ...
      <main role="main">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8 animate-slide-up" style={{animationDelay: '0.4s'}}>
                  Syndic de copropriétés parisiennes depuis 2011, 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                ...
                <div className="group animate-slide-up" style={{animationDelay: '0.1s'}}>
                  <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-secondary to-secondary/50 p-8 border border-secondary/40 hover:border-secondary transition-all duration-500 hover:shadow-2xl hover:shadow-secondary/20 hover:-translate-y-2">
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center space-x-4 mb-6">
                        <div className="w-16 h-16 bg-gradient-to-br from-secondary to-secondary rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-secondary/20">
                          <Users className="w-8 h-8 text-white" />
                        </div>
                        <div>
                          <h3 className="text-2xl font-bold text-foreground group-hover:text-foreground transition-colors">Suivi Individuel</h3>
                          <div className="flex items-center space-x-2 mt-1">
                            <div className="w-2 h-2 bg-secondary rounded-full animate-pulse"></div>
                            <span className="text-sm font-medium text-secondary">Personnalisé</span>
                          </div>
                        </div>
                      </div>
                ...
                <div className="group animate-slide-up" style={{animationDelay: '0.2s'}}>
                  <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-secondary to-secondary/50 p-8 border border-primary/40 hover:border-secondary transition-all duration-500 hover:shadow-2xl hover:shadow-secondary/20 hover:-translate-y-2">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-secondary/20 to-transparent rounded-full blur-2xl"></div>
                    <div className="relative z-10">
                      <div className="flex items-center space-x-4 mb-6">
                        <div className="w-16 h-16 bg-gradient-to-br from-primary to-primary-glow rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-secondary/20">
                          <FileText className="w-8 h-8 text-white" />
                        </div>
                        <div>
                          <h3 className="text-2xl font-bold text-foreground group-hover:text-foreground transition-colors">Contrat Transparent</h3>
                          <div className="flex items-center space-x-2 mt-1">
                            <div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
                            <span className="text-sm font-medium text-primary-ink">Sans Surprise</span>
                          </div>
                        </div>
                      </div>
                      <p className="text-primary-ink/80 leading-relaxed">
                ...
                <div className="group animate-slide-up" style={{animationDelay: '0.3s'}}>
                  <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-secondary to-secondary/50 p-8 border border-secondary/50 hover:border-secondary transition-all duration-500 hover:shadow-2xl hover:shadow-secondary/20 hover:-translate-y-2">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-secondary/20 to-transparent rounded-full blur-2xl"></div>
                    <div className="relative z-10">
                      <div className="flex items-center space-x-4 mb-6">
                        <div className="w-16 h-16 bg-gradient-to-br from-secondary to-secondary rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-secondary/20">
                        ...
                        <div>
                          <h3 className="text-2xl font-bold text-secondary group-hover:text-secondary transition-colors">Équipe Réactive</h3>
                          <div className="flex items-center space-x-2 mt-1">
                            <div className="w-2 h-2 bg-secondary rounded-full animate-pulse"></div>
                            <span className="text-sm font-medium text-secondary">24h/7j</span>
                          </div>
                        </div>
                      </div>
                      <p className="text-secondary/80 leading-relaxed">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="animate-slide-up" style={{animationDelay: '0.1s'}}>
                  <div className="text-center mb-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-secondary to-secondary rounded-2xl flex items-center justify-center mx-auto mb-4">
                      <FileText className="w-8 h-8 text-white" />
                    </div>
                    <h3 className="text-xl font-bold text-secondary mb-2">Administratif</h3>
                    <p className="text-sm text-muted-foreground">Gestion administrative et organisationnelle</p>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-3 bg-secondary-soft rounded-lg hover:bg-secondary-soft transition-colors">
                      <div className="w-8 h-8 bg-secondary rounded-full flex items-center justify-center flex-shrink-0">
                        <Building2 className="w-4 h-4 text-white" />
                      </div>
                      <span className="text-sm font-medium text-foreground">Préservation du patrimoine</span>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-secondary-soft rounded-lg hover:bg-secondary-soft transition-colors">
                      <div className="w-8 h-8 bg-secondary rounded-full flex items-center justify-center flex-shrink-0">
                        <FileText className="w-4 h-4 text-white" />
                      </div>
                      <span className="text-sm font-medium text-foreground">Mise en œuvre des décisions d'AG</span>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-secondary-soft rounded-lg hover:bg-secondary-soft transition-colors">
                      <div className="w-8 h-8 bg-secondary rounded-full flex items-center justify-center flex-shrink-0">
                        <Building className="w-4 h-4 text-white" />
                      </div>
                      <span className="text-sm font-medium text-foreground">Gestion du quotidien et de l'avenir</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="animate-slide-up" style={{animationDelay: '0.2s'}}>
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-primary-ink mb-2">Juridique</h3>
                    <p className="text-sm text-muted-foreground">Conseil et conformité réglementaire</p>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-3 bg-primary-soft rounded-lg hover:bg-primary-soft transition-colors">
                      <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                        <MessageSquare className="w-4 h-4 text-white" />
                      </div>
                      <span className="text-sm font-medium text-foreground">Devoir de conseil</span>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-primary-soft rounded-lg hover:bg-primary-soft transition-colors">
                      <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                        <Users className="w-4 h-4 text-white" />
                      </div>
                      <span className="text-sm font-medium text-foreground">Suivi des évolutions réglementaires</span>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-primary-soft rounded-lg hover:bg-primary-soft transition-colors">
                      <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                        <CheckCircle className="w-4 h-4 text-white" />
                      </div>
                      <span className="text-sm font-medium text-foreground">Respect du règlement</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="animate-slide-up" style={{animationDelay: '0.3s'}}>
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-secondary mb-2">Financière</h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-3 bg-secondary-soft rounded-lg hover:bg-secondary-soft transition-colors">
                      ...
                      <span className="text-sm font-medium text-secondary">Transparence comptable et financière</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-background relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-10 left-10 w-72 h-72 bg-secondary/10 rounded-full blur-3xl animate-pulse"></div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-16">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-secondary to-secondary text-white px-6 py-3 rounded-full mb-8 animate-slide-up shadow-lg">
                ...
                <h2 className="text-5xl md:text-6xl font-bold mb-6 animate-slide-up" style={{animationDelay: '0.2s'}}>
                  <span className="bg-gradient-to-r from-secondary via-secondary to-secondary bg-clip-text text-transparent animate-pulse">Gercop</span> 
              ...
              <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-12 lg:col-span-7 animate-slide-up" style={{animationDelay: '0.1s'}}>
                  <div className="relative h-full">
                    <div className="absolute inset-0 bg-gradient-to-br from-secondary/20 via-secondary/20 to-secondary/20 rounded-3xl blur-xl"></div>
                    <div className="relative bg-gradient-to-br from-secondary to-secondary/60 rounded-3xl p-8 border border-secondary/40 h-full hover:shadow-2xl hover:shadow-secondary/20 transition-all duration-500 group">
                      <div className="flex items-start space-x-6 mb-8">
                        <div className="relative">
                          <div className="w-20 h-20 bg-gradient-to-br from-secondary to-secondary rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300">
                            <Users className="w-10 h-10 text-white" />
                          </div>
                          <div className="absolute -top-1 -right-1 w-4 h-4 bg-primary rounded-full animate-pulse"></div>
                        </div>
                        <div className="flex-1">
                          <h3 className="text-3xl font-bold text-foreground mb-2">Espace Personnel</h3>
                          <p className="text-secondary font-medium">Accès sécurisé à vos données</p>
                        </div>
                      </div>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-4">
                          <div className="flex items-center space-x-3 p-4 bg-white/80 rounded-xl border border-secondary/30 hover:bg-white hover:border-secondary transition-all">
                            <div className="w-8 h-8 bg-secondary rounded-lg flex items-center justify-center">
                              <span className="text-white text-xs font-bold">€</span>
                            </div>
                            <span className="text-foreground font-medium">Situation comptable</span>
                          </div>
                          <div className="flex items-center space-x-3 p-4 bg-white/80 rounded-xl border border-secondary/30 hover:bg-white hover:border-secondary transition-all">
                            <div className="w-8 h-8 bg-secondary rounded-lg flex items-center justify-center">
                              <span className="text-white text-xs font-bold">📋</span>
                            </div>
                            <span className="text-foreground font-medium">Appels de provisions</span>
                          </div>
                        </div>
                        <div className="space-y-4">
                          <div className="flex items-center space-x-3 p-4 bg-white/80 rounded-xl border border-secondary/30 hover:bg-white hover:border-secondary transition-all">
                            ...
                            <span className="text-foreground font-medium">Relevé de dépenses</span>
                          </div>
                          <div className="p-4 bg-gradient-to-r from-secondary to-secondary/600 rounded-xl text-white">
                ...
                <div className="col-span-12 lg:col-span-5 animate-slide-up" style={{animationDelay: '0.2s'}}>
                  <div className="relative h-full">
                    <div className="absolute inset-0 bg-gradient-to-br from-secondary/20 to-secondary/20 rounded-3xl blur-xl"></div>
                    <div className="relative bg-gradient-to-br from-secondary to-secondary rounded-3xl p-6 border border-secondary/50 h-full hover:shadow-2xl hover:shadow-secondary/20 transition-all duration-500 group">
                      <div className="text-center mb-6">
                        <div className="w-16 h-16 bg-gradient-to-br from-secondary to-secondary rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:rotate-6 transition-transform duration-300">
                          <Building2 className="w-8 h-8 text-white" />
                        </div>
                        <h3 className="text-2xl font-bold text-secondary mb-1">Immeuble</h3>
                        <p className="text-secondary text-sm">Documents collectifs</p>
                      </div>
                      
                      <div className="space-y-3">
                        {['Convocations', 'Procès-verbaux AG', 'Comptes-rendus'].map((item, index) => (
                          <div key={item} className="flex items-center space-x-3 p-3 bg-white/70 rounded-lg border border-secondary/30 hover:bg-white transition-all">
                ...
                <div className="col-span-12 animate-slide-up" style={{animationDelay: '0.3s'}}>
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-r from-secondary via-secondary to-secondary rounded-3xl p-8 border border-white/10 overflow-hidden group hover:shadow-2xl hover:shadow-secondary/20 transition-all duration-500">
                      {/* Circuit board pattern */}
                      <div className="absolute inset-0 opacity-10">
                        <div className="absolute top-4 left-4 w-32 h-0.5 bg-secondary"></div>
                        <div className="absolute top-4 left-36 w-0.5 h-16 bg-secondary"></div>
                        <div className="absolute top-20 left-36 w-24 h-0.5 bg-secondary"></div>
                        <div className="absolute bottom-4 right-4 w-40 h-0.5 bg-secondary"></div>
                        <div className="absolute bottom-4 right-44 w-0.5 h-20 bg-secondary"></div>
                      </div>
                      
                      <div className="relative z-10 flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
                        <div className="flex-shrink-0">
                          <div className="w-24 h-24 bg-gradient-to-br from-secondary to-secondary rounded-3xl flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 mb-4">
                            ...
                            <span className="bg-gradient-to-r from-secondary to-secondary text-white px-4 py-1 rounded-full text-sm font-bold">PREMIUM</span>
                          </div>
                          <p className="text-secondary text-lg leading-relaxed">
                            Interface avancée avec accès aux <span className="text-secondary font-semibold">factures</span>, 
                            <span className="text-secondary font-semibold"> contrats</span>, 
                            <span className="text-secondary font-semibold"> interventions</span> et 
                            <span className="text-secondary font-semibold"> sinistres</span> en temps réel.
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-secondary via-secondary to-secondary"></div>
          <div className="absolute top-0 left-0 w-full h-full">
            {/* Formes géométriques */}
            <div className="absolute top-20 left-20 w-32 h-32 border-2 border-secondary rounded-2xl rotate-12 animate-bounce" style={{animationDuration: '3s'}}></div>
            <div className="absolute bottom-32 right-32 w-24 h-24 bg-secondary rounded-full animate-pulse"></div>
            <div className="absolute top-1/2 right-20 w-16 h-64 bg-gradient-to-b from-secondary to-transparent rounded-full rotate-45 opacity-30"></div>
            <div className="absolute bottom-20 left-1/3 w-40 h-2 bg-gradient-to-r from-secondary to-transparent rounded-full"></div>
          </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-20">
                <div className="relative inline-block mb-8">
                  <div className="absolute -inset-4 bg-gradient-to-r from-secondary to-teal-400 rounded-2xl blur-xl opacity-30 animate-pulse"></div>
                  <div className="relative bg-white border-2 border-secondary rounded-2xl px-8 py-4 shadow-xl">
                    <div className="flex items-center space-x-3">
                      <div className="w-4 h-4 bg-red-500 rounded-full animate-ping"></div>
                      <span className="text-secondary font-black text-sm uppercase tracking-widest">LIVE UPDATES</span>
                ...
                <h2 className="text-6xl md:text-7xl font-black mb-6 animate-slide-up" style={{animationDelay: '0.2s'}}>
                  <span className="bg-gradient-to-r from-secondary via-teal-600 to-secondary bg-clip-text text-transparent">Infos</span>
                  <br />
                  <span className="text-secondary">Internet</span>
                </h2>
                <p className="text-2xl text-secondary max-w-3xl mx-auto font-medium animate-slide-up" style={{animationDelay: '0.4s'}}>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-12 gap-6">
                  ...
                  <div className="col-span-12 lg:col-span-8 animate-slide-up" style={{animationDelay: '0.1s'}}>
                    <article className="bg-white rounded-2xl shadow-xl border-l-8 border-secondary overflow-hidden hover:shadow-2xl hover:border-secondary transition-all duration-500 group">
                      <div className="p-8">
                        <div className="flex items-center space-x-4 mb-6">
                          <div className="w-12 h-12 bg-gradient-to-br from-secondary to-teal-500 rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-6 transition-transform duration-300">
                            <Building2 className="w-6 h-6 text-white" />
                          </div>
                          <div>
                            <h3 className="text-2xl font-bold text-secondary">La Vie de ma Copropriété</h3>
                            <p className="text-secondary font-semibold text-sm">NOTIFICATIONS EN TEMPS RÉEL</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          {[
                            ...
                            <div key={index} className={`flex items-center space-x-4 p-4 rounded-xl border-2 transition-all hover:shadow-lg ${item.urgent ? 'border-red-200 bg-red-50' : 'border-secondary bg-secondary'}`}>
                              <div className="text-2xl">{item.icon}</div>
                              <div className="flex-1">
                                <p className="font-medium text-secondary">{item.text}</p>
                                <p className={`text-xs ${item.urgent ? 'text-red-600' : 'text-secondary'}`}>Il y a {item.time}</p>
                              </div>
                              {item.urgent && (
                  ...
                  <div className="col-span-12 lg:col-span-4 space-y-6">
                    ...
                    <div className="animate-slide-up" style={{animationDelay: '0.2s'}}>
                      <div className="bg-gradient-to-br from-teal-500 to-secondary rounded-2xl p-6 text-white shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-500 group">
                    ...
                    {/* Stats rapides */}
                    <div className="animate-slide-up" style={{animationDelay: '0.3s'}}>
                      <div className="bg-white rounded-2xl p-6 shadow-lg border border-secondary">
                        <h4 className="font-bold text-secondary mb-4 text-center">Cette semaine</h4>
                        <div className="grid grid-cols-2 gap-4 text-center">
                          <div>
                            <div className="text-2xl font-bold text-secondary">8</div>
                            <div className="text-xs text-secondary">Notifications</div>
                          </div>
                          <div>
                            <div className="text-2xl font-bold text-teal-600">3</div>
                            <div className="text-xs text-secondary">Interventions</div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="animate-slide-up" style={{animationDelay: '0.4s'}}>
                  <div className="relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-secondary via-secondary to-secondary rounded-2xl blur-xl opacity-50"></div>
                    <div className="relative bg-gradient-to-r from-secondary via-secondary to-secondary rounded-2xl p-8 border border-secondary">
                      <div className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
                        <div className="flex-shrink-0">
                          <div className="w-20 h-20 bg-gradient-to-br from-secondary to-teal-400 rounded-2xl flex items-center justify-center shadow-2xl">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                          ...
                          <p className="text-secondary text-lg leading-relaxed">
                            <span className="text-secondary font-bold">État des comptes</span>, suivi des 
                            <span className="text-teal-400 font-bold"> travaux</span>, des 
                            <span className="text-secondary font-bold"> sinistres</span> et des 
